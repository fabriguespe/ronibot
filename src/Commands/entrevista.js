		...
		try{
			...
			for(let ii in top){
				...
				if(!user.slp_prom){
					...
					if(days>2 && (args[1]=='noti' || args[2]=='noti'))utils.mensajeIngresos("Atención","<@"+ingreso.username+"#"+ingreso.discriminator+">, no se reporta actividad de tu entrevista. Reportate por este canal o seras retirado. \n",message)
				}
