		...
		try{
			...
			for(let ii in top){
				...
				if(!user.slp_prom){
					...
					if(days>2 && args[2]=='noti')utils.mensajeIngresos("Atención","Antención, no se reporta actividad de tu entrevista. Reportate con <@"+DISCORD_JSON+"> por este canal o seras retirado. <@"+user.discord+">\n",message)
				}
