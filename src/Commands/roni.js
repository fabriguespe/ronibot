...
module.exports = new Command({
	...
	async run(message, args, client) {
		...
		if(utils.esJugador(message) && (temporal || utils.esFechaCobros()))row.addComponents(new MessageButton().setCustomId('ver_datos').setLabel('🎮 Datos de Acceso').setStyle('SUCCESS'));
